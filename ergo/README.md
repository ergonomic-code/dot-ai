...
- [`tech/kotlin/coding-conventions.md`](tech/kotlin/coding-conventions.md) — Kotlin language and coding conventions.
...
- [`tech/http-json-api/README.md`](tech/http-json-api/README.md) — HTTP/JSON API conventions.
- [`tech/http-json-api/status-codes.md`](tech/http-json-api/status-codes.md) — HTTP status code choosing rules.
